...
namespace component.netcore.apiclient.seg.v1.Api
{
    ...
    public partial class CardTypeApi : ICardTypeApi
    {
        ...
        /// </summary>
        /// <returns></returns>
        public CardTypeApi(String basePath)
        {
        ...
        /// <returns></returns>
        public CardTypeApi(component.netcore.apiclient.seg.Client.Configuration configuration = null)
        {
        ...
        {
             ApiResponse<List<CardType>> localVarResponse = CardtypeWithHttpInfo();
        ...
        /// <exception cref="component.netcore.apiclient.seg.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (List&lt;CardType&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<CardType>>> CardtypeAsyncWithHttpInfo ()
        {
